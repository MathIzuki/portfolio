...
export default function LetsbefriendsPage() {
  ...
  const sliderImages = [
    "/images/letsbefriends1.webp",
    "/images/letsbefriends2.webp",
    "/images/letsbefriends3.webp",
    "/images/letsbefriends4.webp",
    "/images/letsbefriends5.webp",
  ];
            ...
            <div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mb-8">
                ...
                <ul className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} list-disc pl-6 space-y-3`}>
                  <li>Conception d’un site vitrine statique en collaboration avec un client</li>
                  <li>Mise en avant des services et de l’offre premium de l’entreprise</li>
                  <li>Utilisation d’une charte graphique imposée pour garantir l’identité visuelle</li>
                  <li>Optimisation du design et de l’ergonomie pour une navigation fluide</li>
                  <li>Respect des attentes du client à travers des échanges réguliers</li>
                </ul>
              </motion.div>
            </div>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }} className="space-y-8">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="https://github.com/MathIzuki/Let-s-Be-Friends"
                    target="_blank"
                ...
                <div className="flex gap-4 mt-4">
                  <a
                    href="../documentation/letsbefriendscompterendu.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-center gap-2 transition-colors ${isDarkMode ? "text-gray-300 hover:text-violet-400" : "text-gray-700 hover:text-yellow-500"}`}
                  >
