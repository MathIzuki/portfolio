...
export default function MyCoachPage() {
  ...
  const sliderImages = [
    "/images/mycoach1.webp",
    "/images/mycoach2.webp",
    "/images/mycoach3.webp",
    "/images/mycoach4.webp",
            ...
            <div>
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="mb-8">
                ...
                <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} leading-relaxed text-justify space-y-4`}>
                  MyCoach est un site web dynamique conçu pour faciliter la mise en avant des services d’un coach sportif. 
                  Ce projet individuel a été réalisé durant ma deuxième année de BTS SIO au Lycée Ozenne. 
                  Il permet aux visiteurs de découvrir des séances d’entraînement personnalisées en fonction de leur niveau, 
                  d’accéder à un planning détaillé et d’interagir avec le contenu via une interface intuitive et moderne.
                  Le site intègre un système sécurisé de connexion pour permettre aux utilisateurs enregistrés de réserver des séances et 
                  de filtrer les entraînements selon leur niveau et leur localisation.
                </p>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mb-8">
                ...
                <ul className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} list-disc pl-6 space-y-3`}>
                  <li>Page vitrine présentant les services et les spécialités du coach</li>
                  <li>Affichage dynamique des séances d’entraînement avec filtres avancés</li>
                  <li>Gestion des utilisateurs avec authentification sécurisée</li>
                  <li>Planification et réservation des séances d’entraînement</li>
                  <li>Protection renforcée contre les attaques XSS et injections SQL</li>
                  <li>Stockage sécurisé des mots de passe avec chiffrement</li>
                </ul>
              </motion.div>
            </div>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }} className="space-y-8">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="https://github.com/MathIzuki/MyCoach"
                    target="_blank"
                ...
                <div className="flex gap-4 mt-4">
                  <a
                    href="../documentation/mycoachcompterendu.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-center gap-2 transition-colors ${isDarkMode ? "text-gray-300 hover:text-violet-400" : "text-gray-700 hover:text-yellow-500"}`}
                  >
                    <TbReportAnalytics  className="text-xl" />
                    Compte rendu (Documentation Technique & Utilisateur)
                  </a>
                </div>
