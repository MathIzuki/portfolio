...
export default function DelabonnePage() {
  ...
  const sliderImages = [
    "/images/delabonne1.webp",
    "/images/delabonne2.webp",
    "/images/delabonne3.webp",
    "/images/delabonne4.webp",
    "/images/delabonne5.webp",
  ];
            ...
            <div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mb-8">
                ...
                <ul className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} list-disc pl-6 space-y-3`}>
                  <li>Développement d’un site vitrine dynamique avec WordPress</li>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }} className="space-y-8">
              ...
              <div>
                ...
                <div className="flex gap-4 mt-4">
                  <a
                    href="../documentation/delabonnecahier.pdf"
                    target="_blank"
                  ...
                  >
                    <GiPerspectiveDiceFive  className="text-xl" />
                    Cahier des charges
                  </a>
                </div>
                <div className="flex gap-4 mt-4">
                  <a
                    href="https://delabonne.fr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-center gap-2 transition-colors ${isDarkMode ? "text-gray-300 hover:text-violet-400" : "text-gray-700 hover:text-yellow-500"}`}
                  >
