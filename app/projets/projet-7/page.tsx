...
export default function ValresPage() {
  ...
  const sliderImages = [
    "/images/sitevalres1.webp",
    "/images/sitevalres2.webp",
    "/images/sitevalres3.webp",
    "/images/sitevalres4.webp",
    "/images/sitevalres5.webp",
    "/images/sitevalres6.webp",
    "/images/sitevalres7.webp",
    "/images/sitevalres8.webp",
  ];
            ...
            <div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mb-8">
                ...
                <ul className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} list-disc pl-6 space-y-3`}>
                  <li>Gestion des accès avec rôles définis (Administrateur, Secrétaire, Responsable, Utilisateur)</li>
                  <li>Création, modification, validation et annulation des réservations</li>
                  <li>Affichage en temps réel de la disponibilité des salles</li>
                  <li>Génération de fichiers XML pour l’export des utilisateurs et des réservations validées</li>
                  <li>Interface sécurisée avec authentification et permissions avancées</li>
                </ul>
              </motion.div>
            </div>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }} className="space-y-8">
              ...
              <div>
                ...
                <div className="flex gap-4 mt-4">
                  <a
                    href="../documentation/sitevalrescompterendu.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-center gap-2 transition-colors ${isDarkMode ? "text-gray-300 hover:text-violet-400" : "text-gray-700 hover:text-yellow-500"}`}
                  >
                ...
                <div className="flex gap-4 mt-4">
                  <a
                    href="../documentation/sitevalresdoctech.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-center gap-2 transition-colors ${isDarkMode ? "text-gray-300 hover:text-violet-400" : "text-gray-700 hover:text-yellow-500"}`}
                  >
                ...
                <div className="flex gap-4 mt-4">
                  <a
                    href="../documentation/sitevalresdocutil.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-center gap-2 transition-colors ${isDarkMode ? "text-gray-300 hover:text-violet-400" : "text-gray-700 hover:text-yellow-500"}`}
                  >
