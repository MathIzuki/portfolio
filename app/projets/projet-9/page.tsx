            ...
            <div>
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="mb-8">
                ...
                <p className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} leading-relaxed text-justify space-y-4`}>
                  GSB est une application web développée en équipe de trois personnes dans le cadre de ma formation en BTS SIO. 
                  Ce projet avait pour objectif de concevoir une plateforme de gestion des frais pour une entreprise fictive du secteur médical.
                  Le site permet aux employés de saisir et consulter leurs frais professionnels sous deux catégories : frais au forfait et frais hors forfait.
                  Un système de rôles a été mis en place, avec un visiteur qui peut créer et suivre ses fiches de frais, 
                  tandis qu’un comptable est chargé de les valider et d’en assurer le suivi.
                  Le projet a été conçu en PHP avec une base de données MySQL pour assurer une gestion fluide et sécurisée des informations.
                </p>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mb-8">
                ...
                <ul className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} list-disc pl-6 space-y-3`}>
                  <li>Saisie et gestion des fiches de frais au forfait et hors forfait</li>
                  <li>Affichage détaillé des fiches de frais avec suivi en temps réel</li>
                  <li>Rôle visiteur : création, modification et consultation de ses propres fiches</li>
                  <li>Rôle comptable : validation des frais et gestion des fiches soumises</li>
                  <li>Système d’authentification et gestion des permissions</li>
                  <li>Interface intuitive et responsive pour une expérience utilisateur fluide</li>
                </ul>
              </motion.div>
            </div>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }} className="space-y-8">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="https://github.com/MathIzuki/GSB-WebSite"
                    target="_blank"
